...
class SHA1View: CryptoView {
    ...
    override func viewDidLoad() {
        ...
        walkthrough(headerText: "Take this text:", headerDynamic: message, bodyTitle: "Run it through SHA1. ", bodyDynamic: "IETF RFC 6234's standardized MD5 function", footerText: "The resulting digest:", footerDynamic: digest)
