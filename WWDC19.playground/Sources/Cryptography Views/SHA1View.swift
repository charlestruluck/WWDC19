...
class SHA1View: UIView {
    ...
    func viewDidLoad() {
        let titleLabel = Utilities.createLabel(text: " FUN1 ", fontSize: 32, frame: CGRect(x: 0, y: 0, width: 400, height: 80))
        ...
        let digestString = CryptoSupport.SHA1(string: stringInput)
        ...
        UIView.animateKeyframes(withDuration: 1.54, delay: 0.0, options: [], animations: {
            ...
            titleLabel.animate(newText: " SHA1 ", characterDelay: 0.75)
